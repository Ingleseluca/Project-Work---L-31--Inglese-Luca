...
def run_etl():
    ...
    print("Trasformazione e pulizia dei dati...")
    ...
    print("Creazione della dimensione 'dim_tempo'...")
    ...
    dim_tempo = pd.DataFrame({
        ...
        'giorno_settimana': df_req['datetime_parsed'].dt.day_name() # es. Monday, Tuesday...
    ...
    # Creazione delle Tabelle Fisiche nel Database con SQL DDL
    print("Creazione delle tabelle dello Schema a Stella...")
